...
import ReportIncident from './components/ReportIncident'; // Ensure this filename matches!
...
function App() {
  ...
  return (
    <Router>
      <div style={{ fontFamily: 'Segoe UI, Tahoma, sans-serif', backgroundColor: '#f4f7f6', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: '40px', flex: 1 }}>
          <Routes>
            ...
            {/* Protected Routes */}
            <Route path="/dashboard" element={user ? <Dashboard role={user} /> : <Navigate to="/login" />} />
        ...
        {/* RESTORED FOOTER */}
        <footer style={{ textAlign: 'center', padding: '20px', color: '#7f8c8d', fontSize: '12px', borderTop: '1px solid #e0e0e0', backgroundColor: '#fff' }}>
